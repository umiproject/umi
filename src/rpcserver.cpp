...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* UMI features */
        {"umi", "masternode", &masternode, true, true, false},
        {"umi", "masternodelist", &masternodelist, true, true, false},
        {"umi", "mnbudget", &mnbudget, true, true, false},
        {"umi", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"umi", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"umi", "mnsync", &mnsync, true, true, false},
        {"umi", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"umi", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use umid, or the -server option to umi-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
