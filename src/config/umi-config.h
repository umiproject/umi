/* src/config/umi-config.h.  Generated from umi-config.h.in by configure.  */
/* src/config/umi-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://umi.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Umi Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Umi Core 2.0.0"
