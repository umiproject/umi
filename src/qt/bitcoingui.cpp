                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Umi-Coin") + " - ";
#ifdef ENABLE_WALLET
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Umi Core"), this);
    aboutAction->setStatusTip(tr("Show information about Umi Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Umi"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Umi Core help message to get a list with possible Umi command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Umi Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Umi network", "", count));
}
...
{
    QString strTitle = tr("Umi Core"); // default title
