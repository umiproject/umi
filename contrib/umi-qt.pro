...
RESOURCES += src/qt/umi.qrc src/qt/umi_locale.qrc

TRANSLATIONS += src/qt/locale/umi_bg.ts \
                src/qt/locale/umi_de.ts \
                src/qt/locale/umi_en.ts \
                src/qt/locale/umi_es.ts \
                src/qt/locale/umi_fi.ts \
                src/qt/locale/umi_fr.ts \
                src/qt/locale/umi_it.ts \
                src/qt/locale/umi_ja.ts \
                src/qt/locale/umi_pl.ts \
                src/qt/locale/umi_pt.ts \
                src/qt/locale/umi_ru.ts \
                src/qt/locale/umi_sk.ts \
                src/qt/locale/umi_sv.ts \
                src/qt/locale/umi_vi.ts \
                src/qt/locale/umi_zh_CN.ts \
                src/qt/locale/umi_zh_TW.ts
